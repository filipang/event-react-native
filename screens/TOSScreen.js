...
import { Text,Dimensions, View,ScrollView,Platform } from 'react-native';
...
const TOSScreen = ({ navigation }) => {
    ...
    return (
        ...
        <View style={{ flex: 1, marginTop: Platform.OS === 'ios' ? 34 : 0 }}>
            ...
            <Block center>
            <Text style={{fontSize: 20,marginTop:10}}>TERMS OF SERVICE</Text>
            </Block>
            <ScrollView style={{ marginTop: 50, marginHorizontal: 10 }}><Text style={{ fontSize:14 }}>Terms of Service of MyWebsite.com
My Website ("Us" or "We") provides the MyWebsite.com website and various related services (collectively, the "Website") to you, the User, subject to your compliance with all the terms, conditions, and notices contained or referenced herein (the "Terms of Service"), as well as any other written agreement between us and you.
...
This Terms of Service was created by termsservicetemplate.com for MyWebsite.com
...
Governing Law
These Terms of Service and any dispute or claim arising out of, or related to them, shall be governed by and construed in accordance with the internal laws of the My Country without giving effect to any choice or conflict of law provision or rule.

Any legal suit, action or proceeding arising out of, or related to, these Terms of Service or the Website shall be instituted exclusively in the federal courts of My Country.                                                                                                                                                                                                                                                                                                                                                                   -</Text></ScrollView>
        </View>)
